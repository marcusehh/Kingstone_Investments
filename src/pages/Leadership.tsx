...
const LEADERS: Leader[] = [
  ...
  { name: 'Aaron McEntire', role: 'Chief Risk Officer & Founding Partner',       linkedin: 'https://www.linkedin.com/in/aaron-m-646174296/',       sector: 'Industrials',        bullets: ['As Chief Risk Officer, Aaron is responsible for monitoring portfolio exposure and ensuring the fund\'s positions remain within its risk framework, alongside covering the Industrials sector. He has developed his expertise across multiple financial and accounting departments as an intern at Evans Turner Ltd, Ackroyd London and as an analyst in Loughborough\'s Student-Managed Fund - the largest student-run capital pool nationally. Aaron is an undergraduate at Loughborough University studying BSc Economics & Finance.'] },
