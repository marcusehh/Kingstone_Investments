...
const LEADERS: Leader[] = [
  ...
  { name: 'Lenny Tucker',   role: 'Head of Macroeconomics',                      linkedin: 'https://www.linkedin.com/in/lenny-tucker-3b0324282/', sector: 'Macro & FX', university: 'Bristol',       bullets: ['Lenny leads the fund\'s macroeconomic research as Head of Macroeconomics. He also writes the weekly Kingstone macro-reports covering the rate of inflation, interest and economic growth as well as the key concepts shaping markets. He applies his deep macroeconomic research to form trade theses with a deep awareness of international factors. Lenny is an undergraduate at the University of Bristol studying BSc Economics & Finance.'] }
];
        ...
        <div className="hero-scenic__overlay">
          <div className="hero-scenic__content">
            <div className="page__header">
              ...
              <p className="page__subtitle">All of our team holds the same responsibility in developing pitches and informing investment decisions, covering and not limited to: growth factors, risks and valuation across their respective sectors.</p>
            </div>
        ...
        {LEADERS.map((l) => (
          <article className="leader-card" key={l.name} style={{ position: 'relative' }}>
            ...
            <a href={l.linkedin} target="_blank" rel="noreferrer" className="leader-card__header">
              <h3>{l.name}</h3>
              <p><em>{l.role}</em></p>
              <span className="leader-card__header-line" />
            </a>
