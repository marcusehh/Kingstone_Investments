      ...
      <div className="hero-scenic hero-scenic--leadership">
        <div className="hero-scenic__overlay">
          <div className="hero-scenic__content">
            <div className="page__header">
              ...
              <p className="page__subtitle">All of our team holds the same responsibility in developing pitches and informing investment decisions, covering and not limited to: growth factors, risks and valuation across their respective sectors and asset classes.</p>
            </div>
        ...
        {LEADERS.map((l) => (
          <article className="leader-card" key={l.name} style={{ position: 'relative' }}>
            ...
            <a href={l.linkedin} target="_blank" rel="noreferrer" className="leader-card__header">
              <h3>{l.name}</h3>
              <p><em>{l.role}</em></p>
            </a>
            {l.pfp && <img src={`${import.meta.env.BASE_URL}assets/pfps/${l.pfp}`} alt={l.name} className="leader-card__pfp" />}
            <div className="leader-card__body">
              {l.sector && <span className="leader-card__sector">{l.sector}</span>}
              {l.university && <span className="leader-card__sector">{l.university}</span>}
            </div>
          </article>
        ))}
            </div>
