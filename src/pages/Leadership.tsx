...
const LEADERS: Leader[] = [
  ...
  { name: 'Lenny Tucker',   role: 'Head of Macroeconomics',                      linkedin: 'https://www.linkedin.com/in/lenny-tucker-3b0324282/', sector: 'Macro', university: 'Bristol',       bullets: ['Lenny leads the fund\'s macroeconomic research as Head of Macroeconomics. He also writes the weekly Kingstone macro-reports covering the rate of inflation, interest and economic growth as well as the key concepts shaping markets. He applies his deep macroeconomic research to form trade theses with a deep awareness of international factors. Lenny is an undergraduate at the University of Bristol studying BSc Economics & Finance.'] }
];
