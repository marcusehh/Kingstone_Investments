          ...
          <div className="home-card home-card--podcast" onClick={(e) => { if (!(e.target as HTMLElement).closest('.home-card__link')) { window.open('https://open.spotify.com/show/0VtdGyWOFYEnuu84uR4xXw?si=3e09623dd1764161', '_blank'); } }}>
            ...
            <div className="home-card__links">
              <a href="http://www.youtube.com/@Kingstone.Investments" target="_blank" rel="noreferrer" className="home-card__link" aria-label="YouTube">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.546 12 3.546 12 3.546s-7.505 0-9.377.504A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.504 9.376.504 9.376.504s7.505 0 9.377-.504a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
